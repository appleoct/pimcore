...
class SettingsController extends AdminController
{
    ...
    )
    {
        ...
        // we send the respnse directly here and exit, otherwise this can cause issues with
        // dependencies that changed during the update
    ...
    public function clearOutputCacheAction(Request $request)
    {
        ...
        \Pimcore::getEventDispatcher()->dispatch(SystemEvents::CACHE_CLEAR_FULLPAGE_CACHE);
    ...
    public function clearTemporaryFilesAction(Request $request)
    {
        ...
        \Pimcore::getEventDispatcher()->dispatch(SystemEvents::CACHE_CLEAR_TEMPORARY_FILES);
